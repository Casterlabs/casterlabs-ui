...
<style>
	...
	:global(.clui-input-range-container .clui-input-range-sister .clui-input[type='number']) {
		appearance: textfield;
	}
	:global(.clui-input-range-container .clui-input-range-sister .clui-input[type='number']::-webkit-outer-spin-button),
	:global(.clui-input-range-container .clui-input-range-sister .clui-input[type='number']::-webkit-inner-spin-button) {
